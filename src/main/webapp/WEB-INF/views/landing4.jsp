...
<head>
    ...
    <title>Leaked Scenes</title>

    <link rel="stylesheet" href="resources/css/18css_1.css">
    <link rel="stylesheet" href="resources/css/18css_2.css">
...
<div class="container">
    ...
    <nav class="nav">
        <div class="menu">
            ...
            <p>HOT TV shows</p>
            <p>LIVE Sports</p>
            <p class="show-pc">Free Music</p>
            <p class="show-pc">Online Radio</p>
            <p class="show-pc">HD Anime</p>
            <p class="show-pc">Fantasy</p>
        </div>
        <p class="stripe stripe2 show-pc">
            Please click on the <strong>ALLOW</strong> to stream / download it
        </p>
    </nav>
-->
    <div class="hand show-pc"></div>
    <p class="stripe stripe1 show-pc">
        Please click on the <strong>ALLOW</strong> to stream / download it
    </p>
    <div class="page-container">
        <!--<p class="title show-mobile">Your video is ready</p>-->
        <!--
                    <div class="video">
                        <img src="img/player3.jpg" alt="Player">
                    </div>
                -->
        <!--<div class="bottom">
    ...
    <!--<img src="img/modal2-t.png" class="modal2">-->
    <div class="modal2"></div>
    <p class="stripe stripe3 show-pc">
        Please click on the <strong>ALLOW</strong> to stream / download it
    </p>

</div>
<script>
    function wCenter(url, title, w, h) {
